...
urlpatterns = [
    ...
    path('custom-admin/activity-logs/', views.activity_logs, name='activity_logs'),
    ...
    path('resumes/<int:pk>/clone/', views.resume_clone, name='resume_clone'),
    path('resumes/<int:pk>/export/', views.export_resume, name='export_resume'),
    path('resumes/<int:pk>/export/pdf/', views.export_resume_pdf, name='export_resume_pdf'),
    path('resumes/<int:pk>/export/docx/', views.export_resume_docx, name='export_resume_docx'),
